...
def data_collator(features:list):
    ...
    inputs = [f["tai_wen"] for f in features]
    labels = [f["tai_lo"] for f in features]

    batch = tokenizer.prepare_seq2seq_batch(src_texts=inputs, tgt_texts=labels, max_length=max_input_length, max_target_length=max_input_length)
...
tokenizer = BertTokenizer.from_pretrained('/work/u9296553/aics/seq2seq/data_tgb/fnlp-bart-base-chinese-add-rnn-data')
model = BartForConditionalGeneration.from_pretrained("fnlp/bart-base-chinese")
# model = BartForConditionalGeneration.from_pretrained("/work/u9296553/aics/seq2seq/checkpoints/bart_base_chinese_with_data_rnn/checkpoint-8595")

model.resize_token_embeddings(len(tokenizer))
# defining trainer using 🤗


args = Seq2SeqTrainingArguments(output_dir="./checkpoints/TGB_tailo_to_zh/",
                        do_train=True,
                        do_eval=True,
