...
def main(arg=None):
    ...
    model = Wav2Vec2ForCTC.from_pretrained(input_arg['model_name'])
    ...
    trainer.args.per_device_eval_batch_size = int(input_arg['batch'])
    trainer.args.output_dir = None
    trainer.args.logging_dir = "./input_arg['custom_set_test']"
    print(input_arg['custom_set_test'])
    print(input_arg['model_name'])    
